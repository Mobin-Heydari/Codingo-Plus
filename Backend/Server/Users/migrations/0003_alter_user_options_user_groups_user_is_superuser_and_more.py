...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='user',
            options={'ordering': ['joined_date'], 'verbose_name': 'کاربر', 'verbose_name_plural': 'کاربران'},
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
        ...
        migrations.AlterField(
            model_name='user',
            name='user_type',
            field=models.CharField(choices=[('SMP', 'کاربر ساده'), ('EMP', 'کارمند'), ('ADM', 'مدیر')], default='SMP', max_length=3, verbose_name='نوع کاربر'),
        ),
        migrations.AlterField(
            model_name='user',
            name='username',
